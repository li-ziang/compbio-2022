...
class CellSampler():
    ...
    def __init__(self,
        ...
        if self.sample_batch_id:
            ...
            self.assigned_cluster: pd.Series = adata.obs["assigned_cluster"].astype('category').cat.codes
    ...
    def _high_batch_size(self) -> Iterator[Mapping[str, torch.Tensor]]:
        ...
        if self.sample_batch_id:
            ...
            result_dict['assigned_cluster'] = torch.LongTensor(self.assigned_cluster)
    ...
    def _low_batch_size(self) -> Iterator[Mapping[str, torch.Tensor]]:
        ...
        while count < self.n_epochs:
            ...
            if self.sample_batch_id:
                ...
                result_dict['assigned_cluster'] = torch.LongTensor(self.assigned_cluster[batch])
            yield result_dict
